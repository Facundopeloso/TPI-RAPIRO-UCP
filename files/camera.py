...
Responsabilidades:
- Inicializar y liberar la cámara
- Capturar fotogramas a la frecuencia configurada
- Proveer un generador de frames para el pipeline principal
"""
...
class CameraCapture:
    ...
    def frames(self):
        """
        Generador que emite fotogramas a la frecuencia objetivo (CAMERA_FPS).

        Yields:
            np.ndarray: Frame BGR.
        """
